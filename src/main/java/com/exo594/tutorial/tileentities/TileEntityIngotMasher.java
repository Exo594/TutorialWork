...
import static com.exo594.tutorial.ModAchievements.tutorialItem;
...
public class TileEntityIngotMasher extends TileEntity implements ISidedInventory {
    ...
    ArrayList<ItemStack> mashingResultsList;
    ...
    private boolean canMash() {
        ...
        if (this.slots[1].getItem() == ModItems.furnaceToken && slots[0] != null) {
            result = FurnaceRecipes.smelting().getSmeltingResult(this.slots[0]);
        } else if (this.slots[0].getItem() == ModItems.furnaceToken && slots[1] != null) {
            result = FurnaceRecipes.smelting().getSmeltingResult(this.slots[1]);
    ...
    private void mashItem() {
        if (canMash()) {
            ...
            if (slots[1].getItem() == ModItems.furnaceToken) {
