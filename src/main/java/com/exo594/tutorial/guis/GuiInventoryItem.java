...
public class GuiInventoryItem extends GuiContainer {
     ...
     */
    private static final ResourceLocation iconLocation = new ResourceLocation("tutorial:textures/guis/magic_bag.png");
    ...
    public GuiInventoryItem(EntityPlayer player, InventoryPlayer inv1, InventoryItem inv2) {
        super(new ContainerItem(player, inv1, inv2));
        this.inventory = inv2;
    }
